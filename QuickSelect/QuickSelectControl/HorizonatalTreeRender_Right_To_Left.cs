...
{
    internal class HorizonatalTreeRender_Right_To_Left : IRender
    {
        public HorizonatalTreeRender_Right_To_Left(RectangleF _clientRectangleF)
        {
        ...
        public void RenderNodes(Graphics graphics, IEnumerable<NodeTier> nodeTiers)
        {
            ...
            if (fixedWidth < 50) // TODO: Make this magic numberless.
            {
                fixedWidth = 50;
            }
            ...
            foreach (var source in nodeTiers.Reverse())
            {
                ...
                {
                    var AWholeNewRegion = new Rectangle((int) (i*fixedWidth), (int) (j*height), (int) fixedWidth,
                        (int) height);
                    ...
                    graphics.DrawString(source.Nodes[j].Text, source.Nodes[j].FontFace,
                        new SolidBrush(source.Nodes[j].Theme.ForeColor), AWholeNewRegion);
