...
namespace Etier.IconHelper
{
    ...
    public class IconReader
    {
        ...
        public static Icon GetFolderIcon(IconSize size, FolderType folderType)
        {
            ...
            // Get the folder icon
            var shfi = new Shell32.SHFILEINFO();
            Shell32.SHGetFileInfo("astring",
                // This is a bodge http://stackoverflow.com/questions/1599235/how-do-i-fetch-the-folder-icon-on-windows-7-using-shell32-shgetfileinfo
